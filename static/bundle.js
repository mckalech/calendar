...
var EventsCollection = Backbone.Collection.extend({
	...
	findByDate: function findByDate(date) {
...
},{"../models/eventModel":4,"../utils/date":10,"backbone":16,"backbone.localstorage":15,"moment":19}],2:[function(require,module,exports){
'use strict';
...
$(function () {
	...
	var mainRouter = new MainRouter({ eventsCollection: eventsCollection, currentDate: currentDate });
	var eventsView = new EventsView({ collection: eventsCollection, currentDate: currentDate, router: mainRouter });
	var headerView = new HeaderView({ currentDate: currentDate });
	var sgView = new SGView({ collection: eventsCollection, router: mainRouter });

	Backbone.history.start();
});

},{"./collections/eventsCollection":1,"./models/currentDateModel":3,"./routers/mainRouter":5,"./views/eventsView":11,"./views/headerView":13,"./views/suggestView":14,"backbone":16,"jquery-untouched":17}],3:[function(require,module,exports){
'use strict';
...
var CurrentDateModel = Backbone.Model.extend({
	...
	todayMonth: function todayMonth() {
...
},{"backbone":16,"moment":19,"moment/locale/ru":18}],4:[function(require,module,exports){
'use strict';
...
},{"backbone":16,"moment":19}],5:[function(require,module,exports){
'use strict';
...
var MainRouter = Backbone.Router.extend({
	...
	eventPath: function eventPath(date) {
		this.formView.openForm(date);
	},
	route404: function route404() {
		this.goToMainPage();
	},
...
},{"../views/formView":12,"backbone":16}],6:[function(require,module,exports){
...
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<div class="b-wrap"> <span class="b-header__nav b-header__nav_prev"></span> <span class="b-header__month">'+
((__t=( date ))==null?'':__t)+
'</span> <span class="b-header__nav b-header__nav_next"></span> <span class="b-header__today-btn">Сегодня</span> </div>';
}
return __p;
};
...
__p+=' <td><div class="date">'+
((__t=( texts.days[j] ))==null?'':__t)+
'</div></td> ';
 j++ 
__p+=' ';
 } 
...
__p+=' <td class="b-cell" data-date="'+
((__t=(d))==null?'':__t)+
'"> <div> <div class="date">'+
((__t=( dayText ))==null?'':__t)+
'</div> <div class="title"></div> <div class="description"></div> </div> </td> ';
 } 
__p+=' </tr> ';
 } 
__p+=' </table>';
...
__p+=' <li class="b-search__sg-item" data-date="'+
((__t=( foundEvents[i].date ))==null?'':__t)+
'"><p>'+
((__t=( foundEvents[i].title ))==null?'':__t)+
'</p><span>'+
((__t=( foundEvents[i].dateString ))==null?'':__t)+
'</span></li> ';
 } 
__p+='';
}
...
module.exports = {
	daysInMonth: function daysInMonth(mom) {
		return mom.daysInMonth();
	},
	weeksInMonth: function weeksInMonth(mom) {
	...
	firstDayInMonth: function firstDayInMonth(mom) {
		return this.getNormalDay(moment([mom.year(), mom.month(), 1]));
	},
	getNormalDay: function getNormalDay(mom) {
		return mom.day() > 0 ? mom.day() - 1 : 6;
	},
	isInMonth: function isInMonth(mom, monthMoment) {
...
},{"moment":19}],11:[function(require,module,exports){
'use strict';
...
var EventsView = Backbone.View.extend({
	...
	renderTable: function renderTable(now) {
	...
	renderData: function renderData(now) {
		var that = this;
...
},{"../templates/month.html":8,"../utils/date":10,"backbone":16,"jquery-untouched":17,"moment":19}],12:[function(require,module,exports){
'use strict';
...
var FormView = Backbone.View.extend({
	...
	openForm: function openForm(date) {
	...
	setInputsValues: function setInputsValues(title, description) {
		this.$('.b-popup__title input').val(title);
		this.$('.b-popup__description textarea').val(description);
	},
	setDateText: function setDateText(date) {
...
},{"../models/eventModel":4,"../templates/form.html":6,"backbone":16,"jquery-untouched":17,"moment":19}],13:[function(require,module,exports){
'use strict';
...
},{"../templates/header.html":7,"../utils/date":10,"backbone":16,"jquery-untouched":17,"moment":19}],14:[function(require,module,exports){
'use strict';
...
var SGView = Backbone.View.extend({
	...
	goToSuggestedCell: function goToSuggestedCell(e) {
	...
	bindDocumentEvent: function bindDocumentEvent() {
		var $el,
		    that = this;
...
},{"../templates/sg.html":9,"../utils/date":10,"backbone":16,"jquery-untouched":17,"moment":19}],15:[function(require,module,exports){
/**
